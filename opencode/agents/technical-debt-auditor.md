...
Rank by risk, breadth, cost of delay, and benefit-to-effort—not cosmetic cleanliness. When the user requests a bounded audit, return between 3 and 30 distinct findings and do not pad the list.
