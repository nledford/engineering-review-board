...
HUMAN_CONTROLLED_LIFECYCLE_DOC_TOKENS = {
    "AGENTS.md": (
        ...
        "replay and duplicate/concurrent safety",
    ...
    "docs/engineering-agent-governance.md": (
        ...
        "approved success",
        "unknown result",
        "Add disposable validation-only cases",
        "replay and duplicate/concurrent safety",
    ...
    "docs/implementation-plans/README.md": (
        ...
        "Use validation-only mode for one exact command",
        "Directly observable read, search, LSP, and allowed Git evidence stays with the Orchestrator and creates no Worker Task.",
        "replay-safe and safe under duplicate or concurrent execution",
